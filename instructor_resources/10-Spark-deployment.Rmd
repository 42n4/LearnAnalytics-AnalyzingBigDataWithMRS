...
rxDataStep(taxi_old, taxi_new,
           transforms = list(pickup_nb = factor(pickup_nb, levels = newlevels),
                             ...
                             good_tip = as.factor(ifelse(tip_percent > 0.2, 1, 0))),
