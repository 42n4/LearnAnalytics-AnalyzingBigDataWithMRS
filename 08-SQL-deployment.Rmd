...
To run the examples in this chapter, we need SQL Server 2016 with R Services installed (the stand-alone R Server is not needed). Instructions are shown [here](…). Once R Services is installed we need to enable it by running the following script:
...
[Here](…) is a place to address common installation and configuration issues.
